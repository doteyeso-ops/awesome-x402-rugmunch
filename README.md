...
- [Rug Munch Intelligence](https://rugmunch.io) — **210 tools across 13 chains** (Base, Ethereum, Solana, BSC, Arbitrum, Polygon, Avalanche, Fantom, Gnosis, Optimism, TRON, Bitcoin, SEPA). Crypto security scanner, token forensics, wallet profiling, whale tracking, bundle detection, honeypot checks, contract audit, social analysis, RAG scam detection, and 80+ per-chain variants. $0.01–$0.15 USDC per call. Free trial (1 call/IP/fingerprint), no API keys, no signup. ([Discovery](https://rugmunch.io/.well-known/x402) | [MCP](https://rugmunch.io/mcp) | [OpenAPI](https://rugmunch.io/openapi.json) | [GitHub](https://github.com/Rug-Munch-Media-LLC/))
